...
// generates signed URLs for uploading media to Google Cloud Storage, using PUT method and V4 signatures, valid for 15 minutes
@Component
public class SignedUrlGenerator {
	...
	public URL generatePutUrl(String bucket, String objectPath, String contentType) {
		...
		return storage.signUrl(blobInfo, 15, TimeUnit.MINUTES, Storage.SignUrlOption.httpMethod(HttpMethod.PUT),
