...
public class GCSService {
	...
	/**
	 * Generates a signed URL for the thumbnail version of a given GCS image path.
	 * The thumbnail is expected at thumbnails/{filename} in the same bucket,
	 * generated by the GCP Cloud Function.
	 *
	 * @param gcsPath
	 *            the GCS path of the original image
	...
	public String uploadObject(String objectName, byte[] data, String contentType) {
		...
		BlobInfo blobInfo = BlobInfo.newBuilder(bucketName, objectName).setContentType(sanitizedContentType).build();
