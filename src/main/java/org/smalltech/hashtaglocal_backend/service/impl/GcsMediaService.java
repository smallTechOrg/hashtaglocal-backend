...
// service for generating signed URLs for media uploads to Google Cloud Storage, using a file naming
// policy and MIME type mapping to determine the object path and content type of the uploaded media
@Service
