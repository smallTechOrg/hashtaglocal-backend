...
public class IssueHomeV2Controller {
	...
	public IssueHomeV2Controller(IssueRepository issueRepository, MediaRepository mediaRepository,
	...
	@GetMapping
	@Operation(summary = "Get issues within radius", description = "Returns a List of issues within 5km radius of the given lat/lng coordinates with user, location, locality and viewer context.")
	...
	public APIResponse getIssuesNearby(@RequestParam("lat") double lat, @RequestParam("lng") double lng) {
		...
		List<org.smalltech.hashtaglocal_backend.entity.IssueEntity> issueEntities = issueRepository
				.findByStatusInAndCreatedAtAfterAndWithinRadius(statusStrings, fourMonthsAgo, lat, lng, radiusMeters);
