...
// @GetMapping("/issues")
// @Operation(summary = "Get issue Home", description = "Returns a List of
// issues with user, location, locality and viewer context. Optionally filter by
// locality hashtag.")
// @ApiResponse(responseCode = "200", description = "Successful issue response",
// content = @Content(mediaType = "application/json", schema =
// @Schema(implementation = APIResponse.class)))
// public APIResponse getIssues(@RequestParam(value = "locality", required =
// false) String localityHashtag) {
