...
/**
 * Stores raw locality discoveries from each source (GeoNames, OSM, India Post)
 * before deduplication. One row per source discovery.
 */
@Entity
...
public class RawLocalityDiscovery {
	...
	public enum DiscoverySource {
		GEONAMES, OSM, INDIAPOST
	}

	public enum LocalityType {
		CITY, TOWN, DISTRICT, UNKNOWN
	}
