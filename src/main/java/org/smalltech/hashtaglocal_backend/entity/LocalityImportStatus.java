...
/**
 * Tracks each locality import attempt with Google Maps validation results. One
 * row per discovered locality import in a job, showing status and errors.
 */
@Entity
...
public class LocalityImportStatus {
	...
	public enum ImportStatus {
		SUCCESS, FAILED, SKIPPED, NO_DATA_FOUND
	}
