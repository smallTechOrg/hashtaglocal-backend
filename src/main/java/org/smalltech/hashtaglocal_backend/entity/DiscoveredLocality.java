...
/**
 * Represents deduplicated localities after merging raw discoveries from multiple sources. One row
 * per unique locality (by name + state), containing merged information and confidence scores from
