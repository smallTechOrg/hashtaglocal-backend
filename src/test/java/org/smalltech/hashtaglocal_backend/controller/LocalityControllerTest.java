...
class LocalityControllerTest {
  ...
  @Mock private LocalityService localityService;

  @InjectMocks private LocalityController localityController;
  ...
  void testGetAllLocalitiesWithPolygons_Success() {
    // Arrange
    LocalityDTO.PolygonDTO polygon1 =
        LocalityDTO.PolygonDTO.builder()
            .type("Polygon")
            .coordinates(
                new double[][][] {
                  {
    ...
    LocalityDTO.PolygonDTO polygon2 =
        LocalityDTO.PolygonDTO.builder()
            .type("Polygon")
            .coordinates(
                new double[][][] {
