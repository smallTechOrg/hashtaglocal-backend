...
class GoogleMapsGeocodingServiceTest {
  ...
  @InjectMocks private GoogleMapsGeocodingService geocodingService;
  ...
  void shouldSuccessfullyReverseGeocode() {
    ...
    GoogleMapsLocationDTO.AddressComponent cityComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("Bengaluru")
            .shortName("Bengaluru")
            .types(List.of("locality", "political"))
            .build();

    GoogleMapsLocationDTO.AddressComponent stateComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("Karnataka")
            .shortName("KA")
            .types(List.of("administrative_area_level_1", "political"))
            .build();

    GoogleMapsLocationDTO.AddressComponent countryComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("India")
            .shortName("IN")
            .types(List.of("country", "political"))
            .build();

    GoogleMapsLocationDTO.AddressComponent streetComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("Sarjapur - Marathahalli Road")
            .shortName("Sarjapur - Marathahalli Rd")
            .types(List.of("route"))
            .build();

    GoogleMapsLocationDTO.AddressComponent districtComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("Bellandur")
            .shortName("Bellandur")
            .types(List.of("sublocality_level_1", "sublocality"))
            .build();

    GoogleMapsLocationDTO.AddressComponent postalComponent =
        GoogleMapsLocationDTO.AddressComponent.builder()
            .longName("560103")
            .shortName("560103")
            .types(List.of("postal_code"))
            .build();

    List<GoogleMapsLocationDTO.AddressComponent> components =
        List.of(
            cityComponent,
            stateComponent,
            countryComponent,
    ...
    GoogleMapsLocationDTO.Result result =
        GoogleMapsLocationDTO.Result.builder()
            .formattedAddress(
                "Sarjapur - Marathahalli Road, Bellandur, Bengaluru, Karnataka 560103, India")
            .addressComponents(components)
            .build();

    GoogleMapsLocationDTO response =
        GoogleMapsLocationDTO.builder().results(List.of(result)).status("OK").build();
    String jsonResponse;
    try {
  ...
  void shouldReturnNullWhenNoResults() {
    ...
    GoogleMapsLocationDTO response =
        GoogleMapsLocationDTO.builder().results(new ArrayList<>()).status("ZERO_RESULTS").build();
    String jsonResponse;
    try {
      jsonResponse = new ObjectMapper().writeValueAsString(response);
    } catch (Exception e) {
