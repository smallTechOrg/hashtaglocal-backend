...
class LocalityServiceTest {
	...
	void testGetAllLocalitiesWithPolygons_Success() {
		...
		Locality locality1 = Locality.builder().id(1L).hashtag("indiranagar").name("Indiranagar").geoBoundary(polygon1)
				.build();

		Locality locality2 = Locality.builder().id(2L).hashtag("koramangala").name("Koramangala").geoBoundary(polygon2)
				.build();
	...
	void testPolygonConversionToGeoJSON() {
		...
		Locality locality = Locality.builder().id(1L).hashtag("test").name("Test Locality").geoBoundary(polygon)
				.build();
	...
	void testGetAllLocalitiesWithPolygons_NullPolygon() {
		// Arrange
		Locality locality = Locality.builder().id(1L).hashtag("test").name("Test Locality").geoBoundary(null).build();
